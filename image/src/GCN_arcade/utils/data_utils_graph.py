...
# create GNN dataset (tensor)
class CustomDataset(InMemoryDataset):
    def __init__(self, root='./', filepath='./compact/Arcade/',
                 name='Arcade', use_edge_attr=True, transform=None,
        ...
        # self.slices: A slice dictionary for reconstructing single examples from this object

    @property
    def raw_dir(self):
        """default: self.root/raw"""
        return self.filepath

    @property
    def processed_dir(self):
        """default: self.root/processed"""
        return os.path.join(self.root, self.name)

    @property
    def raw_file_names(self):
        """File names of the raw files, won't trigger download if they exist"""
        return self.filenames

    @property
    def processed_file_names(self):
        """Return the list of file names processed by the process() method"""
        return ['data.pt']
    ...
    def process(self):
        """main process for data preprocessing and saved to processed_dir"""
